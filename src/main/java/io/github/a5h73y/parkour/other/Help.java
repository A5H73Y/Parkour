...
public final class Help {
    ...
    public static void lookupCommandHelp(String[] args, CommandSender sender) {
        ...
        } else if (command.equals("setautostart")) {
        ...
        } else if (command.equals("setcreator")) {
        ...
        } else if (command.equals("linkkit")) {
        ...
        } else if (command.equals("listkit")) {
        ...
        } else if (command.equals("setmaxdeath")) {
        ...
        } else if (command.equals("setmaxtime")) {
        ...
        } else if (command.equals("rewardonce")) {
        ...
        } else if (command.equals("rewardlevel")) {
        ...
        } else if (command.equals("rewardleveladd")) {
        ...
        } else if (command.equals("rewardrank")) {
        ...
        } else if (command.equals("rewardparkoins")) {
        ...
        } else if (command.equals("rewarddelay")) {
        ...
        } else if (command.equals("createkit")) {
        ...
        } else if (command.equals("editkit")) {
        ...
        } else if (command.equals("validatekit")) {
